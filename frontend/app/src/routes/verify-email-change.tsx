...
import { useEmailChangeVerification } from "@/features/auth/hooks/useEmailChangeVerification";
...
function VerifyEmailChangePage() {
  ...
  const { verificationStatus, errorMessage } = useEmailChangeVerification(token);
      ...
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-center">Verifying your new email</CardTitle>
      ...
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <Card className="w-full max-w-md">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Your email address has been successfully updated. Please sign in with your new email.
            </CardDescription>
          </CardHeader>
